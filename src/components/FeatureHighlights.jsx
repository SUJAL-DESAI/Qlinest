    ...
    <section className="bg-white text-[#001d3d] py-16 px-6 md:px-20">
      ...
      <div className="max-w-xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 relative">
          ...
          />
          {/* Play Button */}
          <button className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white text-blue-600 rounded-full p-4 shadow-md hover:scale-105 transition">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="currentColor"
